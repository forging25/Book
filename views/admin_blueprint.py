...
from Book.fetcher.cache import get_the_latest_chapter
from Book.config import LOGGER, CONFIG
        ...
        try:
            ...
            if books_url:
                ...
                for i in books_url:
                    ...
                    item_result["last_read_chapter_name"] = last_read_chapter_name
                    result.append(item_result)
                return template('search_user.html', title='{name}的书架'.format(name=name),
                                is_login=1,
                                user=user,
                                username=name,
                                is_bookmark=1,
